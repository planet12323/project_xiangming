...
CREATE TABLE IF NOT EXISTS point_info (
    property_id VARCHAR(16) PRIMARY KEY NOT NULL,
...
CREATE TABLE IF NOT EXISTS command_data (
    time_stamp TIMESTAMP NOT NULL,
    command_id VARCHAR(16) NOT NULL REFERENCES command_params(command_id),
...
CREATE TABLE IF NOT EXISTS analysis_results (
    time_stamp TIMESTAMP NOT NULL,
    analysis_id VARCHAR(16) NOT NULL REFERENCES data_analysis(analysis_id),
...
CREATE TABLE IF NOT EXISTS display_results (
    time_stamp TIMESTAMP PRIMARY KEY NOT NULL, -- 30分钟边界时间
    selected_points JSONB NOT NULL,
    calculation_method VARCHAR(32) NOT NULL, -- 熵值法/平均值法/最大值法
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
